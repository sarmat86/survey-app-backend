...
module.exports = buildSchema(`
  ...
  type Mutation {
    ...
    createChoice(questionId: ID!, content: String!, position: Int): Choice!
    updateChoice(choiceId: ID!, content: String, position: Int): Choice!
    deleteChoice(choiceId: ID!): Boolean!
